...
export default function HigienicSection() {
  return (
    <div className="w-full max-w-[90%] mx-auto bg-[#F5F5F5] pt-8 rounded-3xl mt-20 ring-2 ring-gray-300 shadow-lg">
      <h2 className="font-light text-2xl md:text-4xl text-center">
        <br /> <span className="font-sans from-neutral-400 text-3xl font-bold" style={{ textShadow: '2px 2px 4px #e5771b' }}>MEDICIONES HIGIÉNICAS</span>
      </h2>
          ...
          <div className="flex flex-col items-start justify-start py-6 gap-6"> 
            ...
            <div className="flex items-center justify-center gap-6 p-2 w-full max-w-md">
              ...
              <div className="flex flex-col items-start justify-start gap-1 w-full"> 
                <h3 className="md:text-xl font-medium">Medición legal puesta a tierra PAT</h3>                
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-6 p-2 w-full max-w-md">
              ...
              <div className="flex flex-col items-start justify-start gap-1 w-full"> 
                <h3 className="md:text-xl font-medium">Medición de iluminación</h3>                
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-6 p-2 w-full max-w-md">
              ...
              <div className="flex flex-col items-start justify-start gap-1 w-full"> 
                <h3 className="md:text-xl font-medium">Medición sonora</h3>                
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-6 p-2 w-full max-w-md">
              ...
              <div className="flex flex-col items-start justify-start gap-1 w-full"> 
                <h3 className="md:text-xl font-medium">Medición carga térmica</h3>                
              </div>
            </div>
