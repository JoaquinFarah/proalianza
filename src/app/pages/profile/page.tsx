  ...
  return (
    <div className="bg-gray-50">      
      ...
      <div className="relative h-screen">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-1 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
            ...
            <div className="lg:pr-4">
                ...
                <h1 className="mt-30 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">
                Nuestra Misión
                </h1>
                <p className="mt-6 text-xl/8 text-gray-700">
        ...
        <div className="relative isolate overflow-hidden px-6 py-24 sm:py-1 lg:overflow-visible lg:px-0">        
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-2 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        
        {/* Imagen - Ahora a la izquierda */}
        <div className="-mt-10 -ml-12 p-12 lg:sticky lg:top-20 lg:col-start-1 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
        <Image 
            src="/mirror.jpg" 
            alt="Icono" 
            width={2000} 
        ...
        <div className="lg:pr-4">
            ...
            <p className="mt-6 text-xl/8 text-gray-700">
                Pro Alianza® Es una empresa de Servicios de Asistencia Técnica, Capacitación, Entrenamiento, Calibración de Sistemas de Detección...
            </p>
            ...
            <p className="mt-6 text-xl/8 text-gray-700">
                Volcar nuestra experiencia en el análisis de operaciones industriales...
            </p>
            ...
            <p className="mt-6 text-xl/8 text-gray-700">
                Ser una empresa líder en nuestra especialidad...
            </p>
            </div>
        </div>
        </div>
        ...
        <div className="lg:pr-4">
            ...
            <ul role="list" className="space-y-8 text-gray-600">
                ...
                <span>
                    <strong className="font-semibold text-gray-900">Soluciones inteligentes.</strong> Somos concientes de las necesidades de nuestros clientes...
                </span>
                </li>
                <li className="flex gap-x-3">
                <LockClosedIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
                <span>
                    <strong className="font-semibold text-gray-900">Seguridad en lo que hacemos.</strong> Tanto nuestras vidas como las de nuestros clientes...
                </span>
                </li>
                <li className="flex gap-x-3">
                <ServerIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
                <span>
                    <strong className="font-semibold text-gray-900">Formación constante.</strong> Parte de crecer es enseñar...
                </span>
                </li>
            </ul>               
            </div>
